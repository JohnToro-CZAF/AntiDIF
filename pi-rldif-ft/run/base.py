...
class DLTrainer:
    ...
    def _get_lightning_params_from_config(
        ...
        print('n.b number of gpus')
        print(env_config.n_gpus)
        print(f'device is {torch.device("cuda" if torch.cuda.is_available() else "cpu")}')
        ...
        if env_config.n_gpus == 0:
            #n.b added these two lines to work with cpu.
            d["accelerator"] = "cpu"
            d["devices"] = 1
